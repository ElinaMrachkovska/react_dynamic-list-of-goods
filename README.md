...
- відсортувати їх за назвою;
- та показати перші 5;
1. `Load red goods` має завантажити всі товари, показуючи лише `червоні`;
1. Сервер має лише 1 кінцеву точку, яка повертає всі товари, тому вам слід виконати всю підготовку у відповідних методах у `/api/goods`.
1. `GoodsList` майже завершено, вам просто потрібно використати відповідні кольори для `li`;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://ElinaMrachkovska.github.io/react_dynamic-list-of-goods/) and add it to the PR description.
